...
class UtilsTestCase(unittest.TestCase):
    ...
    def test_get_endpoints_from_section(self):
        cfg = get_config(b"""
            ...
            listen_addr = 1.1.1.1
        """)
        self.assertEqual(["tcp:23:interface=1.1.1.1"], get_endpoints_from_section(cfg, "ssh", 23))
        ...
        """)
        self.assertEqual(["tcp:23:interface=1.1.1.1", "tcp:23:interface=2.2.2.2"], get_endpoints_from_section(cfg, "ssh", 23))
        ...
        """)
        self.assertEqual(["tcp:23:interface=1.1.1.1", "tcp:2323:interface=1.1.1.1"], get_endpoints_from_section(cfg, "ssh", 23))
